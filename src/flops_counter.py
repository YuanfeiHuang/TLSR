...
# This code is based on https://github.com/sovrasov/flops-counter.pytorch

def get_model_complexity_info(model, input_res, is_cuda=False, input_plus=False,print_per_layer_stat=True, as_strings=True,
    ...
    if input_constructor:
        ...
        if input_plus:
            batch = {"value": torch.FloatTensor(1, *input_res), "num_samples": 16, "DoT": torch.zeros(1), "transi_learn": False}
        else:
